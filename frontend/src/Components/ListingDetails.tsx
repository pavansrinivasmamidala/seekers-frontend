        ...
        <div className="flex mt-4 align-middle justify-evenly">
          ...
          <div className=" w-[30vw] relative flex border shadow-lg flex-col px-12  rounded-lg my-6 ">
            <div className="mx-2 my-4 flex justify-between">
              <span className="font-semibold text-3xl">${data?.price} CAD night </span>
            ...
            <div className="my-4 flex flex-col">
              <span className="text-md ">
               <span className="text-gray-500"> Location:</span> {data?.address.building}, {data?.address.street},
                {data?.address.city}
              </span>

              <span className="text-md">
                <span className="text-gray-500">Country:</span> {data?.address.country}
              </span>
            </div>

            <div className="text-md">
              <span className="text-gray-500">Ameneties:</span>
              <span> {data?.amenities[0]}, {data?.amenities[4]}, {data?.amenities[2]} </span>
            </div>
